...
class CarelevoPumpPluginTempBasalTest : CarelevoPumpPluginTestBase() {
    ...
    fun `setTempBasalAbsolute should return not enacted when bluetooth is disabled`() {
        ...
        val result = plugin.setTempBasalAbsolute(1.2, 30, testProfile, false, PumpSync.TemporaryBasalType.NORMAL)
    ...
    fun `setTempBasalPercent should succeed on success response`() {
        ...
        val result = plugin.setTempBasalPercent(150, 30, testProfile, false, PumpSync.TemporaryBasalType.NORMAL)
    ...
    fun `setTempBasalPercent should fail when use case errors`() {
        ...
        assertThrows(IllegalStateException::class.java) {
            plugin.setTempBasalPercent(150, 30, testProfile, false, PumpSync.TemporaryBasalType.NORMAL)
        }
    }
